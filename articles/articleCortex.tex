...
\title{Advance shape statistics for the cortex}

\author[1]{PRIETO Juan-Carlos\thanks{juanprietob@gmail.com}}
\author[2]{PIZER Stephen\thanks{pizer@cs.unc.edu}}


\affil[1]{CREATIS, INSA, Lyon, France}
\affil[2]{MIDAG, University of North Carolina, Chapel Hill}
...
Most state of the art methods to model shape of the cortex use surface information only.
There is an increasing need to support volumetric information.
In this work, we use a technique for shape modeling that is
able to model surface and internal features.
Besides shape characterization, a technique to differentiate objects by shape is needed.
This requires computing statistics on shape. The shape modeling technique called s-reps is suited for this purpose.
The main contribution of this work is the procedure to generate the s-rep of the cortex. 
...
\cite{drury_computerized_1996}, \cite{hermosillo_unfolding_1999}, \cite{fischl_cortical_1999}, \cite{pons_area_2004}. %Some statistical methods use this parameterizations to pe the analysis. 
...
\begin{figure} 
 \centering  
 \epsfig{file = s-repSlab.eps, width = 8cm}
